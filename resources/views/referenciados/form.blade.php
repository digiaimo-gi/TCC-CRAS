...
<div class="subcontent">
    <form>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="dataNasc" class="form-control" id="inputDataNasc" placeholder="dd/mm/AAAA">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputRG" class="col-sm-2 col-form-label">RG</label>
            <div class="col-sm-10">
                <input type="RG" class="form-control" id="inputRG" placeholder="XX.XXX.XXX-XX">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputCPF" class="col-sm-2 col-form-label">CPF</label>
            <div class="col-sm-10">
                <input type="CPF" class="form-control" id="inputCPF" placeholder="XXX.XXX.XXX/XX">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputNIS" class="col-sm-2 col-form-label">NIS</label>
            <div class="col-sm-10">
                <input type="NIS" class="form-control" id="inputNIS" placeholder="XXX.XXXXX.XX-X">
            </div>
        </div>
        <hr/>
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="Telefone1" class="form-control" id="inputTelefone1" placeholder="(XX) ?XXXX-XXXX">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="custom-select mr-sm-2" id="selectogradouro">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="NomeLogradouro" class="form-control" id="inputNomeLogradouro" placeholder="Nome do Logradouro">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputNumeroEndereco" class="col-sm-2 col-form-label">Número</label>
            <div class="col-sm-10">
                <input type="Numero" class="form-control" id="inputNumeroEndereco" placeholder="Número do Logradouro">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputComplemento" class="col-sm-2 col-form-label">Complemento</label>
            <div class="col-sm-10">
                <input type="Complemento" class="form-control" id="inputComplemento" placeholder="Número do Complemento">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputBairro" class="col-sm-2 col-form-label">Bairro</label>
            <div class="col-sm-10">
                <input type="Bairro" class="form-control" id="inputBairro" placeholder="Nome do Bairro">
            </div>
        </div>
        <hr/>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="dataInclusao" class="form-control" id="inputDataInclusao" placeholder="dd/mm/AAAA">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputDataInclusaoPaif" class="col-sm-2 col-form-label">Data Inclusão PAIF</label>
            <div class="col-sm-10">
                <input type="dataInclusaoPaif" class="form-control" id="inputDataInclusaoPaif" placeholder="dd/mm/AAAA">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputDataExclusaoPaif" class="col-sm-2 col-form-label">Data Exclusão PAIF</label>
            <div class="col-sm-10">
                <input type="dataExclusaoPaif" class="form-control" id="inputDataExclusaoPaif" placeholder="dd/mm/AAAA">
            </div>
        </div>
        <div class="form-group row">
            <label for="textareaObservacoes" class="col-sm-2 col-form-label">Observações</label>
            <div class="col-sm-10">
                <textarea class="form-control" id="textareaObservacoes" rows="5" placeholder="Insira aqui observações sobre as modificações feitas no prontuário, como mudança de endereço, telefone ou status"></textarea>
            </div>
        </div>
        <div class="form-group row">
            <label for="inputDataModificacao" class="col-sm-2 col-form-label">Data Modificação</label>
            <div class="col-sm-10">
                <input type="dataModificacao" class="form-control" id="inputDataModificacao" placeholder="dd/mm/AAAA">
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-10">
